        ...
        return (
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-600 my-10 mx-auto text-white">
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={googleHandler} title='Google' aria-label="Log in with Google" className="p-3 rounded-sm">
                    ...
                    <button onClick={facebookHandler} aria-label="log in with facebook" title="Facebook" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
